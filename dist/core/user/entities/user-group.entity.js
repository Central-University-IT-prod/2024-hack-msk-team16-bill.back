...
], UserGroupEntity.prototype, "userId", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => entities_1.GroupBillEntity, (groupBill) => groupBill.id, {
        nullable: true,
        cascade: true,
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    ...
    __metadata("design:type", entities_1.GroupBillEntity)
], UserGroupEntity.prototype, "groupBillId", void 0);
exports.UserGroupEntity = UserGroupEntity = __decorate([
    (0, typeorm_1.Entity)({ name: 'user-group' })
], UserGroupEntity);
